...
import type { StorefrontVariants, StorefrontSection } from "@/lib/types"
...
const sharedProducts: SeedProduct[] = [
  {
...
const fitnessProducts: SeedProduct[] = [
  {
...
const performanceApparelProducts: SeedProduct[] = [
  {
    slug: "form-tee-black",
...
const storefronts: SeedStore[] = [
  ...
  },
  {
    ...
    categories: [
      { id: "new-fitness", title: "New Arrivals", image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=400&auto=format&fit=crop" },
      { id: "activewear", title: "Activewear", image: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?q=80&w=400&auto=format&fit=crop" },
      { id: "footwear", title: "Footwear", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=400&auto=format&fit=crop" },
      { id: "equipment", title: "Equipment", image: "https://images.unsplash.com/photo-1517438984742-1262db08379e?q=80&w=400&auto=format&fit=crop" },
      { id: "supplements", title: "Supplements", image: "https://images.unsplash.com/photo-1579722820308-d74e571900a9?q=80&w=400&auto=format&fit=crop" },
    ],
...
const storeThemes: Record<string, { logoUrl?: string; primaryColor?: string; accentColor?: string }> = {
  'galaxy-watch': {
    primaryColor: '0.488 0.243 264.376',
    accentColor: '0.488 0.243 264.376',
  },
  'fitness-wear': {
    primaryColor: '0.596 0.145 163.225',
