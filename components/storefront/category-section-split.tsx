  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
      {featured ? (
        ...
        >
          <img src={featured.image || ""} alt={featured.title} loading="lazy" decoding="async" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" />
